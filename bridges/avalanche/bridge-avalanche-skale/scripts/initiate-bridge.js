...
async function main() {
  ...
  if (!bridgeAddress || !tokenAddress || !amount || !destinationAddress) {
    throw new Error("Please set BRIDGE_ADDRESS, TOKEN_ADDRESS, AMOUNT, and DESTINATION_ADDRESS in your .env file");
  }
